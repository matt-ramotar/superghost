...
DOWNLOAD_URL_PREFIX="${DOWNLOAD_URL_PREFIX:-${RELEASE_GITHUB_BASE_URL}/releases/download/$TAG/}"
RELEASE_NOTES_URL="${RELEASE_NOTES_URL:-${RELEASE_GITHUB_BASE_URL}/releases/tag/$TAG}"
